...
hyper_ranger_sample_fraction = UniformFloatHyperparameter("lrn_ranger__fra", 0.1, 1, default_value = 0.1)
hyper_xgboost_eta = UniformFloatHyperparameter('lrn_xgboost_eta', 0.001, 0.3, default_value = 0.1)
hyper_xgboost_max_depth = UniformIntegerHyperparameter('lrn_xgboost_depth', 1, 14, default_value = 5)
hyper_xgboost_subsample = UniformFloatHyperparameter('lrn_xgboost_sub', 0.5, 1, default_value = 0.5)
hyper_xgboost_colsample_bytree = UniformFloatHyperparameter('lrn_xgboost_colsample_by_tree', 0.5, 1, default_value = 0.5)
